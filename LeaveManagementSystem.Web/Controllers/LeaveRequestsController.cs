...
{
    [Authorize]
    public class LeaveRequestsController(ILeaveTypeService _leaveTypesService, ILeaveRequestService _leaveRequestsService) :Controller
    {
        ...
        {
            // Validate the days dont exceed allocation
