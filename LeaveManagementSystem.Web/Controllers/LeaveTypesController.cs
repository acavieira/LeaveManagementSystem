...
namespace LeaveManagementSystem.Web.Controllers
{
    ...
    public class LeaveTypesController(ILeaveTypeService _leaveTypeService) : Controller
    {
        ...
        private const string NameExistsValidationMessages = "This leave type already exists in the database";
        ...
        {
            /*if (leaveTypeCreate.Name.Contains("vacations"))
            { 
                ModelState.AddModelError("Name", "Leave type cannot contain the word 'vacations'.");
            }*/

            if (await _leaveTypeService.CheckIfLeaveTypeExists(leaveTypeCreate.Name))
            {
                ModelState.AddModelError(nameof(leaveTypeCreate.Name),NameExistsValidationMessages);
            }
        ...
        public async Task<IActionResult> Edit(int id, LeaveTypeEditVM leaveTypeEdit)
        {
            ...
            {
                ModelState.AddModelError(nameof(leaveTypeEdit.Name), NameExistsValidationMessages);
            }
